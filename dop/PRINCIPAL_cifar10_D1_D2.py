...
h5 = Flatten()(h4)
h6 = Dropout(0.5)(h5)
#h7 = DopDense("relu", 50, n_dop_neurons, threshold = 0.00018, refractory_period = 2, gamma = 0.3)(h6)
...
with open("dop_history_d1d2_" + str(n_dop_neurons) + "_dop_neurons.pkl", 'wb') as fp:
